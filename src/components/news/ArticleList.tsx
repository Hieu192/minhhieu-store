  ...
  return (
    <section className="md:col-span-2 space-y-6">
      {posts.length === 0 ? (
        ...
        // Dùng grid để chia các bài viết thành 2 cột
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {posts.map((post) => (
            ...
            //       <h2 className="text-xl font-semibold text-gray-800 mb-2 hover:text-blue-600 min-h-[3.5rem]">
            //         {post.title}
            //       </h2>
