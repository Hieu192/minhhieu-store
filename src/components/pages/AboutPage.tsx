    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Về MinhHieu</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Được thành lập từ năm 2020, MinhHieu đã trở thành một trong những thương hiệu uy tín
              trong lĩnh vực cung cấp vật liệu xây dựng và thiết bị trang trí nội thất.
            </p>
            <p className="text-gray-600 mb-4">
              Với hơn 5 năm kinh nghiệm, chúng tôi hiểu rõ nhu cầu của khách hàng và luôn
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Cam kết giao hàng trong vòng 24-72h tại TP.HCM</p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
