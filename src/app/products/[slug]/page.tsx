...
//         setProduct(null); // đảm bảo null nếu lỗi
//       })
...
//   //   console.log('Thumbnail clicked:', img, index);
//   //   setMainImage(img);
...
export default async function Page({ params }: { params: { slug: string } }) {
  ...
  try {
    ...
    const res = await fetch(`${baseUrl}/api/products/${slug}`, {
      next: { revalidate: 60 }, // optional: ISR nếu muốn caching
    });
    ...
    return <div className="p-6 text-center text-red-500">Có lỗi xảy ra</div>;
  }
}
